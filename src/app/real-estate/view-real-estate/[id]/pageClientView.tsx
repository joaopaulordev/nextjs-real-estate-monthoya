...
export default function RealEstate({ responseImovel }: { responseImovel: Imovel }) {
...
//   const { responseImovel, isLoadingImovel } = useImovelView(Number(id)); 
  ...
  useEffect(() => {
    // Safely access window object on the client side
            ...
            <div className="sticky top-4 flex flex-col items-start justify-center gap-4 w-full max-w-xsS">
                <div className="flex items-center gap-2">
                    <div className="flex items-center gap-2 bg-green-600 text-white px-4 py-3 rounded-lg">
                        <a href={`https://api.whatsapp.com/send?phone=44997338154&text=Olá, gostaria de mais informações sobre o imóvel: ${fullUrl}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
